...
import { BookOpen, Calendar, Eye, MoreHorizontal } from "lucide-react";
...
export default function UserBooksTable({ books }: UserBooksTableProps) {
        ...
        return (
            <div className="text-center py-8">
                ...
                <p className="text-gray-500">
                    This user hasn't uploaded any books yet.
                </p>
            </div>
        );
    }
                    ...
                    >
                        <div className="flex space-x-4">
                            ...
                            <div className="flex flex-col ">
                                ...
                                {openDropdown === book.id && (
                                    <div className="absolute right-20 mt-1 w-36 bg-white rounded-md shadow-lg border z-60 flex flex-col">
                                        <button
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                handleStatusUpdate(
                                            ...
                                            className="w-full px-3 py-2 text-left text-sm hover:bg-gray-50 font-medium cursor-pointer"
                                        >
                                            {book.status === 1
                                                ? "Suspend Book"
                                                : "Unsuspend Book"}
